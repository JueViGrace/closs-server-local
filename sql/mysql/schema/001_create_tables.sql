...
CREATE TABLE IF NOT EXISTS operti (
  ...
  upickup varchar(30) NOT NULL DEFAULT '',
  uverif varchar(30) NOT NULL DEFAULT '',
  uembala varchar(30) NOT NULL DEFAULT '',
  idcarrito varchar(20) NOT NULL DEFAULT '',
...
CREATE TABLE keol_opti2 (
  ...
  opti2_documento varchar(8) NOT NULL,
  opti2_condcred char(1) NOT NULL DEFAULT '',
  opti2_tipodocsal char(1) NOT NULL DEFAULT '',
  opti2_pedstatus char(2) NOT NULL DEFAULT '',
  opti2_cond char(1) NOT NULL DEFAULT '',
  opti2_agesal varchar(3) NOT NULL DEFAULT '',
  opti2_ubica varchar(40) NOT NULL DEFAULT '',
  opti2_totbultos decimal(8,3) NOT NULL DEFAULT '0.000',
  opti2_totpeso decimal(8,3) NOT NULL DEFAULT '0.000',
  opti2_fchyhora datetime NOT NULL DEFAULT '0001-01-01 00:00:01',
  opti2_usuario varchar(30) NOT NULL DEFAULT '',
  opti2_totexento decimal(24,7) NOT NULL DEFAULT '0.0000000',
  opti2_totneto decimal(24,7) NOT NULL DEFAULT '0.0000000',
  opti2_totiva decimal(24,7) NOT NULL DEFAULT '0.0000000',
  opti2_totdivisas decimal(24,7) NOT NULL DEFAULT '0.0000000',
  opti2_tasa decimal(24,7) NOT NULL DEFAULT '0.0000000',
  opti2_agenfac varchar(3) NOT NULL DEFAULT '',
  opti2_tdocfac varchar(3) NOT NULL DEFAULT '',
  opti2_docufac varchar(8) NOT NULL DEFAULT '',
  opti2_agendesp varchar(3) NOT NULL DEFAULT '',
  opti2_docudesp varchar(8) NOT NULL DEFAULT '',
  opti2_id_empresa varchar(6) NOT NULL DEFAULT ' ',
  opti2_bstotiva decimal(24,7) NOT NULL DEFAULT '0.0000000',
  opti2_bsflete decimal(24,7) NOT NULL DEFAULT '0.0000000',
  opti2_nbsflete decimal(24,7) NOT NULL DEFAULT '0.0000000',
  opti2_ndolflete decimal(24,7) NOT NULL DEFAULT '0.0000000',
  kti_negesp char(1) NOT NULL DEFAULT '0',
  opti2_dtotdescuen decimal(24,7) NOT NULL DEFAULT '0.0000000',
  opti2_fchentrega datetime NOT NULL DEFAULT '0001-01-01 00:00:01',
  opti2_geoloc varchar(100) NOT NULL DEFAULT ' ',
  opti2_latitud varchar(12) NOT NULL DEFAULT ' ',
  opti2_longitud varchar(12) NOT NULL DEFAULT ' ',
  opti2_notasent text,
  dolarflete int(1) NOT NULL DEFAULT '0',
  KEY keol_opti2_idx1 (opti2_agencia,opti2_tipodoc,opti2_documento),
  KEY keol_opti2_idx2 (opti2_agenfac,opti2_tdocfac,opti2_docufac)
);
